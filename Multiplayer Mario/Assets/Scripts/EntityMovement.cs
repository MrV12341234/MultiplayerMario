...
public class EntityMovement : MonoBehaviour
{
    ...
    private void FixedUpdate() // fixed update is called at a set intravel, not linked to the users FPS. Use FixedUpdate for physics so its the same on all fps
    {
        ...
        velocity.y += Physics2D.gravity.y * speed; // calling Physics2D is a built-in gravity function in Unity. goto Project Settings, Physics2D to change gravity on enimies, or define variable gravity at top
